...
try {
    ...
    $PgGame->query('INSERT INTO md_update_history (note) VALUES ($1)', ['bulkload_m_npc_point_hero']);
    ...
    for ($level = 1; $level <= 3; $level++)
    {
        ...
        {
            shuffle($hero_list);
            $hero_pk = $Hero->getNewHero('POINT', null, $hero_list[0]['rare_type'], $hero_list[0]['m_hero_base_pk'], null, null, null, 'npc_point');
