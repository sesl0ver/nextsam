...
jqGrid_templete = {
	'cheat' : {
		...
		'body' : [
			...
			{'name' : 'posi_title', 'index' : 'posi_title', 'fixed' : true, 'width' : 140, 'align' : 'center', 'sortable' : false},
			{'name' : 'type', 'index' : 'type', 'fixed' : true, 'width' : 140, 'align' : 'center', 'sortable' : false},
...
function get_log_search_result(appendTarget, post_data)
{
	...
	var templete = jqGrid_templete['cheat'];
