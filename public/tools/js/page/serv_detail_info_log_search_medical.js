...
function grid_request(_search_type, _list_offset, _add)
{
	// 검색 버튼 누르면
	let post_data = {};
...
jqGrid_templete = {
	'medical' : {
		'header' : ['일시', '웹ID', '군주', '좌표', '구분', '황금', '치료영웅', '상세'],
		'body' : [
			...
			{'name' : 'gold', 'index' : 'gold', 'fixed' : true, 'width' : 100, 'align' : 'center', 'sortable' : false},
			{'name' : 'hero_pk', 'index' : 'hero_pk', 'fixed' : true, 'width' : 100, 'align' : 'center', 'sortable' : false},
...
function get_log_search_result(appendTarget, post_data)
{
	...
	var templete = jqGrid_templete['medical'];
