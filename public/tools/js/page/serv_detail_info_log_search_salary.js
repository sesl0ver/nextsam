...
jqGrid_templete = {
	'salary' : {
		...
		'body' : [
			...
			{'name' : 'lord_name', 'index' : 'lord_name', 'fixed' : true, 'width' : 200, 'align' : 'center', 'sortable' : false},
			{'name' : 'posi_title', 'index' : 'posi_title', 'fixed' : true, 'width' : 200, 'align' : 'center', 'sortable' : false},
			{'name' : 'type', 'index' : 'type', 'fixed' : true, 'width' : 200, 'align' : 'center', 'sortable' : false},
			{'name' : 'gold', 'index' : 'gold', 'align' : 'center', 'sortable' : false},
...
function get_log_search_result(appendTarget, post_data)
{
	...
	var templete = jqGrid_templete['salary'];
