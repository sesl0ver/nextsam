...
jqGrid_templete = {
	'temp' : {
		...
		'header' : ['일시', '군주', '좌표', '구분', '통솔', '공격측 최대병력', '공격측 영향력', '방어측 영향력', '전투 타입', '윤리도' ,'공격측 병력', '사기저하', '효과', '승패여부', '사기'],
		'body' : [
			{'name' : 'log_date', 'index' : 'log_date', 'fixed' : true, 'width' : 113, 'align' : 'center', 'sortable' : false},
			{'name' : 'lord_name', 'index' : 'lord_name', 'fixed' : true, 'width' : 120, 'align' : 'center', 'sortable' : false},
			{'name' : 'posi_pk', 'index' : 'posi_pk', 'fixed' : true, 'width' : 70, 'align' : 'center', 'sortable' : false},
			{'name' : 'type', 'index' : 'type', 'fixed' : true, 'width' : 100, 'align' : 'center', 'sortable' : false},
			{'name' : 'leadership', 'index' : 'leadership', 'fixed' : true, 'width' : 100, 'align' : 'center', 'sortable' : false},
			{'name' : 'att_lead_population', 'index' : 'att_lead_population', 'fixed' : true, 'width' : 100, 'align' : 'center', 'sortable' : false},
			{'name' : 'att_power', 'index' : 'att_power', 'fixed' : true, 'width' : 100, 'align' : 'center', 'sortable' : false},
			{'name' : 'def_power', 'index' : 'def_power', 'fixed' : true, 'width' : 100, 'align' : 'center', 'sortable' : false},
			{'name' : 'relation', 'index' : 'relation', 'fixed' : true, 'width' : 100, 'align' : 'center', 'sortable' : false},
			{'name' : 'morals', 'index' : 'morals', 'fixed' : true, 'width' : 100, 'align' : 'center', 'sortable' : false},
			{'name' : 'att_lead_limit_population', 'att_lead_limit_population' : 'type', 'fixed' : true, 'width' : 100, 'align' : 'center', 'sortable' : false},
			{'name' : 'fightingSpiritDown', 'index' : 'fightingSpiritDown', 'fixed' : true, 'width' : 100, 'align' : 'center', 'sortable' : false},
			{'name' : 'ret_value', 'index' : 'ret_value', 'fixed' : true, 'width' : 100, 'align' : 'center', 'sortable' : false},
			{'name' : 'win', 'index' : 'win', 'fixed' : true, 'width' : 100, 'align' : 'center', 'sortable' : false},
			{'name' : 'fightingSpirit', 'index' : 'fightingSpirit', 'fixed' : true, 'width' : 100, 'align' : 'center', 'sortable' : false}
		]
	}
}
...
function get_log_search_result(appendTarget, post_data)
{
	...
	var templete = jqGrid_templete['temp'];
